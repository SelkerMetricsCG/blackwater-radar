...
| File | What |
|---|---|
| `rivers_config.py` | The rivers: gauge, drainage area, SNOTEL stations, runnable threshold, flow bands, radar region. Add a river here. |
...
About 25 s per river without figures, 35 s with, plus the upload.
